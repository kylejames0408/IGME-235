...
function searchButtonClicked(){
    ...
    // 10 - update the UI
    document.querySelector("#status").innerHTML = "<b>Searching for '" + displayTerm + "'</b><img src='../images/spinner.gif' height=10px>";
...
function dataLoaded(e){
    ...
    for (let i=0;i<results.length;i++){
        ...
        line += `<span><a target='_blank' href='${url}'>View on Giphy</a><p>Rating: ${(result.rating ? result.rating : "NA").toUpperCase()}</span></div>`;
